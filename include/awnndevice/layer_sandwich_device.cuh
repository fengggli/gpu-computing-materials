...
status_t relu_forward_device(tensor_t const d_x, lcache_t* cache, tensor_t d_y);
...
// create all the intermidate buffer all caches inside this sandwich layer
