...
TEST_F(TensorOpTest, test_tpose1230) {
  ...
  T p1230[] = {1, 0, 1, 0, 1, 0, 1, 1, 1, 2, 3, 2, 1, 0, 1, 2, 1, 2};
...
TEST_F(TensorOpTest, DISABLED_test_tpose1230) {
  uint const shape_x[] = {2, 3, 4, 4}; // 2x3x4x4
  uint const shape_w[] = {3, 3, 4, 6}; // 3x3x4x6
